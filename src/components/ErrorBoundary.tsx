          ...
          <div className="max-w-xl w-full">
            <div className="flex flex-col items-center text-center mb-6">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                An unexpected error occurred.<br />You can try again or copy the details below to report the issue.
              </p>
            </div>

            <div className="relative bg-muted/30 border border-border/50 rounded-lg overflow-hidden">
              <div className="flex items-center justify-between px-3 py-2 border-b border-border/50">
                <span className="text-[11px] text-muted-foreground/60 font-mono">Error Details</span>
                <button
